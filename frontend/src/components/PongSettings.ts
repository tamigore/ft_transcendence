...
export const SetLeftPaddleSpeed = 17/setVeloDiv;
...
export const SetRightPaddleSpeed = 17/setVeloDiv;

export const setRightPaddleColor = "#e9ec33";
// BALL PARAMETERS
export const setBallRadius = 8;

export const setBallStartSpeedX = 1;
export const setBallStartSpeedY = 1;
