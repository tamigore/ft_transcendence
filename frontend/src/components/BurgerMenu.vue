<template>
  <div>
    ...
    <div ref="bmBurgerButton" class="bm-burger-button" style="top: 18px" @click="openMenu" :class="{ hidden: !burgerIcon }">
      <i class="pi  pi-comment" style="font-size: 4rem; color: #9b26d2;"></i>
          ...
          handler(oldValue, newValue) {
            if (oldValue) {
              this.$nextTick(() => {
                ...
                document.querySelector('.cross-style').style.right= '20vw';
              });
            }
            if (newValue) {
              if (
